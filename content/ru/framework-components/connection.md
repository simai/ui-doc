...
результат, клавиатурное управление, фокус и доступное имя. Общее подключение
описано в [разделе «Старт»](/ru/start/installation/), а координаты каждого
компонента — в [справочнике](/ru/framework-components/reference/).
