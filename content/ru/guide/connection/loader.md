...
После загрузки Core Loader находит классы и обычный компонент кнопки и подключает доступные для них модули. Подключение и работа Smart-компонентов описываются отдельно.
