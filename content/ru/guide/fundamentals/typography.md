...
Выбирайте типографическую роль по назначению текста. Это сохраняет иерархию, адаптивность и единое изменение шрифта во всём проекте.
...
в разделе [«Интервалы»](/ru/guide/fundamentals/spacing/).

## Что дальше

Посмотрите [адаптивные размеры](/ru/guide/fundamentals/adaptive-sizing/) или найдите точные классы в [каталоге типографических утилит](/ru/utilities/typography/).
