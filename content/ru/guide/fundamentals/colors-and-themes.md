...
Выбирайте семантическую роль по назначению элемента. Так один и тот же класс сохраняет смысл в светлой и тёмной темах, даже если фактический цвет меняется.
...
Изучите [дизайн-токены](/ru/guide/fundamentals/design-tokens/) или откройте точные цветовые классы в [каталоге утилит](/ru/utilities/).
