...
Используйте этот способ для первого знакомства и быстрой проверки версии `v5.4.0` без сборщика и backend.
...
- [Подключение к реальному проекту](/ru/guide/connection/project-setup/) — локальные файлы,
  CDN и структура публичной папки.
- [Основы оформления](/ru/guide/fundamentals/) — условия, размеры, цвета и типографика.
