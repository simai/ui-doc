---
title: "Editor"
description: "Атрибуты, события и примеры Smart-компонента editor."
---
...
Поставляемые ассеты:
Не поставляется в текущем пакете: `smart/editor/css/editor.css`.
Не поставляется в текущем пакете: `smart/editor/js/editor.js`.
...
Не поставляется в текущем пакете: `smart/editor`.
