---
title: "Admin Menu"
description: "Комплексный Smart-компонент боковой навигации административного приложения."
---

# Admin Menu

**Тип:** комплексный Smart-компонент (`kind: composite`).
...
Поставляемые ассеты:
- `simai/ui-smart@77feccf8867a5676bad2cd78fbb3497d25816fac:smart/admin-menu/js/admin-menu.js`
- `simai/ui-smart@77feccf8867a5676bad2cd78fbb3497d25816fac:smart/admin-menu/template/default.js`
...
настройки и координация зависимостей принадлежат этому комплексному
Smart-компоненту.
...
- `simai/ui-smart@77feccf8867a5676bad2cd78fbb3497d25816fac:smart/admin-menu`
- `simai/ui@1e886550a147bf63d7c3a4440af5e5855aaee485:distr/rule/rule.json#name=cl-admin-menu`
