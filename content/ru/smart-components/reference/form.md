---
title: "Form"
description: "API и runtime-контракт Smart-компонента form в SIMAI Framework 5.4.0 candidate."
---
...
Идентификатор: `smart.form`. Smart-компонент заблокирован; жизненный цикл — экспериментальный.
...
Поставляемые ассеты:
- `simai/ui-smart@b57afb30c9b790212afcf451e16ae6e27a5ab6af:smart/form/js/form.js`
...
- `simai/ui-smart@b57afb30c9b790212afcf451e16ae6e27a5ab6af:smart/form`
