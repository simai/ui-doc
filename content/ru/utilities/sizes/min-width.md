...
адаптивны
 макетов, когда необ
одимо гарантировать, что элемент не станет уже заданного порога ширины даже при
ограничения
 окружающего контейнера или содержимого.
...
В этом примере минимальная ширина будет 100% (`min-w-full`) только при размера
 экрана `md` и больше.
## Playground
