...
В SIMAI Framework с помощью модификаторов можно задать ширину элемента. С помощью данны
 классов можно быстро определить
...
удобство при создании адаптивны
 дизайнов.
...
- Модификатор (обязательный параметр):
    ...
    - `w-min` — ширина по минимально необ
одимой для контента
...
Для адаптивного изменения ширины используйте префиксы контрольны
 точек:
...
В этом примере ширина будет 50% (`w-1/2`) только при размера
 экрана `md` и больше.
## Playground
