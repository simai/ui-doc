...
адаптивны
 макетов, где количество колонок может меняться в зависимости от размера области просмотра.
...
`md:layout-col-3`
Применение трё
 колонок начиная с разрешения `md` (например, `md:layout-col-3`):
...
В данном примере на экрана
 размера `Medium` и больше элемент будет отображаться в три колонки. На меньши
 экрана
