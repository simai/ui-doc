...
Модификаторы `grid-column` позволяют задавать колонки и и
 интервалы в сетке, управляя шириной и расположением элементов по горизонтали.
...
- Контрольная точка *(необязательный параметр)*: применяет модификатор начиная с указанного брейкпоинта (`sm`, `md`, `lg`, `xl`). Если не указана — действует для все
 размеров.
...
Чтобы менять расположение на определённы
 брейкпоинта
, добавьте контрольную точку:

```html
<div class="col-span-6 md:col-span-3 lg:col-span-2">
  <!-- элемент занимает разную ширину на разны
 экрана
 -->
</div>
```
