...
В SIMAI Framework с помощью модификаторов можно управлять размером автоматически создаваемы
 столбцов сетки, для которы
 не задана явная ширина. Это помогает гибко адаптировать макет под разные сценарии и размеры экрана.
