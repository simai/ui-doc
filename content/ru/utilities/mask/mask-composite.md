...
С помощью модификаторов композиции маски можно комбинировать несколько слоев маски, определяя логику и
 взаимодействия
друг с другом.
...
- **mask-add** – текущий слой маски отображается под нижним слоем, и
 результирующая область суммируется.
