...
Модификаторы из этого раздела задают одновременное выравнивание элементов сетки или флексбокса в ячейка
 относительно
обеи
 осей одновременно.
...
*(Обратите внимание, что в ис
одном коде был класс `items-text-center`, но по описанию это `items-center`.)*
