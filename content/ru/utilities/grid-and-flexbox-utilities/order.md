...
Данный модификатор управляет порядком отображения элементов в потоке раскладки, не изменяя и
 логический порядок в
документе.
...
- Модификатор *(обязательный параметр)*:
    ...
    - `order-{1...12}` — изменяет порядок элемента в рамка
 от 1 до 12\.
