---
title: "Визуально скрытый контент"
...
:badge[sr-only]{type=main scheme=on-surface size=1}
...
## Пример
:::example {id="utilities/interactivity/sr-only" label="Визуально скрытый контент"}
:::
