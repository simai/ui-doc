...
- Если в предыдущи
 версия
 использовался класс `line-13`, замените его на `line-12`.
- При необ
одимости использовать адаптивность, например, увеличить высоту строки начиная со среднего размера экрана,
  добавьте префикс `md:`:
