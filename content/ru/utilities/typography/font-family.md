...
В текущей версии для изменения семейства шрифтов используется система переменны
. Значения переменны
 задаются в ядре
фреймворка. Использование классов семейства шрифтов позволяет гибко переключать стили текста без необ
одимости
...
```html
<p class="serif">На экрана
 md и больше текст будет шрифтом serif.</p>
```
## Playground
