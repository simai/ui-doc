...
<p class="lighter">Текст будет визуально тоньше относительно ис
одного</p>
<p class="bolder">Текст будет визуально толще относительно ис
одного</p>
...
чтобы сделать текст полужирным на экрана
 medium и больше:

```html
<p class="md:bold">
  Текст будет полужирным на экрана
 размером Medium и больше.
</p>
```
## Playground
