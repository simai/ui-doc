...
темы. Для обычного текста на повер
ности используйте следующую иерар
ию:
...
- `.color-on-surface-inverse` — текст на инверсной повер
ности.
...
|:--|:--|:--|
| `.color-on-surface` | `--sf-on-surface` | Основной текст на повер
ности |
...
| `.color-on-surface-inverse` | `--sf-on-surface-inverse` | Текст на инверсной повер
ности |
| `.color-on-surface-inverse-fixed` | `--sf-on-surface-inverse-fixed` | Фиксированный текст на инверсной повер
ности |
...
`--sf-on-surface-variant` и предназначен только для необязательны
, визуально
приглушённы
 подписей. Готовый класс `.color-on-surface-muted` в текущем наборе
