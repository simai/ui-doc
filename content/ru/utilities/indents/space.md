...
| .space-x-reverse     | реверсирует направление горизонтальны
 отступов          |
| .space-y-reverse     | реверсирует направление вертикальны
 отступов            |
{.table}
...
&lt;iframe title="Пример в Playground" loading="lazy" src="https://play.simai.io/embed.html?component=indents&group=space"&gt;&lt;/iframe&gt;
&lt;/div&gt;
