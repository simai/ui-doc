...
которые должны со
ранять определённые пропорции, например, контейнеров для видео или изображений.
...
Эти классы обеспечат, что контейнеры будут иметь заданное соотношение сторон, независимо от и
 ширины.
...
&lt;iframe title="Playground: Aspect Ratio" loading="lazy" src="https://play.simai.io/embed.html?component=layout&group=aspect-ratio"&gt;&lt;/iframe&gt;
&lt;/div&gt;
