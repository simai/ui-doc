---
title: 'Оформление элемента, разбитого на несколько строк'
description: 'Управляет продолжением фона, границы и отступов у фрагментированного элемента.'
tags: [box-decoration-break]
---

# Оформление элемента, разбитого на несколько строк

:badge[box-decoration-break]{type=main scheme=on-surface size=1}
...
Сравните единое оформление всей строки с отдельным оформлением каждого перенесённого фрагмента.

:::example {id="utilities/layout/box-decoration-break" label="Сравнение фрагментов"}
:::
