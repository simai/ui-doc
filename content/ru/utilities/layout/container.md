...
Контейнер используется для ограничения ширины и добавления горизонтальны
 отступов в зависимости от размера области
...
Для центрирования используйте логическую утилиту `m-inline-auto`. Она одинаково
работает в LTR и RTL:
...
Если стандартного максимума недостаточно, добавьте `max-container-1..8` на
родителя. Не задавайте ширину в пикселя
: модификаторы связаны с токенами
системы размеров.
## Playground
