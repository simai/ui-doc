---
title: "Метод расчёта размера элемента"
description: "Определяет, входят ли граница и внутренний отступ в заданный размер элемента."
tags: [box-sizing]
---

# Метод расчёта размера элемента

:badge[box-sizing]{type=main scheme=on-surface size=1}
...
Обе области получают одинаковые ширину, высоту, границу и отступ. Отличается только способ расчёта итогового размера.

:::example {id="utilities/layout/box-sizing" label="Сравнение расчёта"}
:::
