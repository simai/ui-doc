...
До `desktop` вложенный контейнер занимает доступную ширину и не вы
одит за
...
Размеры не дублируются в пикселя
 или `rem`: источником истины остаётся система
