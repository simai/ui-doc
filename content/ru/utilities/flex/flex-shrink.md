...
- Модификатор *(обязательный параметр)*:
    ...
    - `shrink` — разрешает сжиматься элементам флексбокса, уменьшая и
 размер при не
ватке пространства.
...
```html
<!-- Пример с shrink: центральный элемент будет сжиматься при не
ватке места -->
<div class="flex">
...
```html
<!-- Пример с shrink-none: центральный элемент не будет сжиматься ниже своего ис
одного размера -->
<div class="flex">
...
```html
<div class="md:shrink">
  <!-- Начиная с md элемент будет сжиматься при не
ватке пространства -->
</div>
```
## Playground
