...
Для плавного пере
ода нужны числовые начальное и конечное значения. Пере
оды между `auto`, `fit-content`, `max-content` и `100%` могут отрабатывать скачком, потому что браузер не всегда может интерполировать такие значения.
