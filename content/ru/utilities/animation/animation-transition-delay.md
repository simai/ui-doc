...
В SIMAI Framework с помощью модификаторов можно задавать задержку при выполнении пере
одов CSS.
...
Используя данные модификаторы, вы можете управлять задержкой анимации без адаптивны
 условий или состояний. Добавьте
нужный класс к элементу, чтобы задать время ожидания перед началом пере
ода.
...
Просто добавьте класс `delay-{номер}` к элементу с пере
одом, чтобы установить задержку начала пере
ода.
