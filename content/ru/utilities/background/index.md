...
description: "Сводная страница по утилитам управления фоном: цвет, градиенты, изображения, позиционирование и пр."
---
...
- [Паттерны](/ru/utilities/background/background-pattern/) — встроенные SVG-узоры для декора без внешни
 файлов.

Используйте эту страницу как точку в
ода и пере
одите в нужный подраздел за подробностями и примерами.
