---
title: "Полоса прокрутки при наведении"
...
:badge[scroll-hover]{type=main scheme=on-surface size=1}
...
:::example {id="utilities/overscroll/scroll-hover" label="Полоса прокрутки при наведении"}
:::
