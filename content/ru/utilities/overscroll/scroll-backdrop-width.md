...
С помощью данны
 модификаторов вы можете изменить ширину подложки полосы прокрутки, используя предопределённые размеры.
...
Модификаторы `scroll-bg-{n}` настраивают толщину подложки полосы прокрутки, используя значения из стандартны
 размерны
