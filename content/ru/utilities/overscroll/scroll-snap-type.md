...
С помощью данного пакета модификаторов вы можете настроить, будет ли контейнер всегда останавливать прокрутку в точка
...
- **snap-mandatory**: Заставляет контейнер останавливаться ровно на точка
 привязки.
- **snap-proximity**: Позволяет контейнеру останавливаться на точка
 привязки, только когда они на
одятся достаточно
