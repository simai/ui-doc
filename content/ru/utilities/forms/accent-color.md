...
элементов управления формы, таки
 как чекбоксы и радиокнопки. Это позволяет легко стилизовать акцентные элементы,
...
Эти модификаторы задают акцентный цвет для элементов управления формами, таки
 как чекбоксы или радиокнопки. С помощью
