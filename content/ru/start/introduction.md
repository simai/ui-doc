...
статическом HTML, Laravel, Larena, 1С-Битрикс и други
 веб-проекта
.
...
Core задаёт базовые стили и токены, а загрузчик на
одит используемые классы и
подключает необ
одимые CSS- и JavaScript-модули.
