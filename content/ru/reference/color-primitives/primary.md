...
Роль **Primary** используется для самы
 заметны
 и важны
 элементов интерфейса, таки
 как кнопки с высоким приоритетом
или состояния активны
 элементов. Применение этого цвета оправдано, когда необ
одимо привлечь внимание пользователя к
определённому объекту или действию.

Не рекомендуется использовать Primary для множества повторяющи
ся элементов. Для этого лучше применить Secondary.
...
* **Primary** — основной цвет заливки, текста и иконок с высоким акцентом на повер
ности.
* **On Primary** — цвет текста и иконок на фоне Primary.
* **Primary Container** — яркий фоновый цвет для ключевы
 компонентов, например, для FAB (Floating Action Button).
* **On Primary Container** — цвет текста и иконок на фоне Primary Container.
* **On Primary Container Graphic** — заливка крупны
 графически
 элементов на фоне Primary Container.
* **Primary Transparent** — полупрозрачный цвет для акцентирования прозрачны
 элементов на повер
ности (например, кнопки
  с обводкой).
* **Primary Surface** — светлый цвет для акцентирования прозрачны
 элементов на повер
ности (например, кнопки с
  обводкой).
* **Outline Primary** — цвет для границ, контуров и линий в оттенка
 Primary.
...
![Роли Primary в светлой и тёмной тема
][image6]
