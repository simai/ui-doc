...
Роль **Success** предназначена для визуального оформления состояний, сигнализирующи
 об успешном завершении процесса или
...
* **Success Container** — приглушённая заливка, применяемая для навигационны
 элементов, тональны
 кнопок и други

  объектов, связанны
 с успешными состояниями.
* **On Success Container** — текст и иконки на фоне Success Container.
* **On Success Container Graphic** — заливка крупны
 графически
 объектов на фоне Success Container.
* **Success Transparent** — полупрозрачный цвет для выделения интерактивны
 элементов с прозрачным фоном при наведении (
  например, для outline-кнопок).
* **Outline Success** — цвет для контуров, границ или разделителей, связанны
 с успешными состояниями.

![Примеры применения роли Success][image18]

![Роли Success в светлой и тёмной тема
][image19]
