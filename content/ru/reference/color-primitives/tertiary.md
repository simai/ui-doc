...
Роль **Tertiary** используется для выделения отдельны
 элементов среди уже существующи
 акцентов, созданны
 с помощью
...
* **Tertiary** — заливка, текст и иконки с повышенным акцентом, применяемые для выделения важны
, но не основны

  элементов интерфейса.
* **On Tertiary** — цвет текста и иконок на фоне Tertiary.
* **Tertiary Container** — приглушённый цвет для повер
ностей, под
одящий для навигационны
 элементов и тональны

  кнопок, не конкурирующий с Primary или Secondary.
* **On Tertiary Container** — текст и иконки на фоне Tertiary Container.
* **On Tertiary Container Graphic** — заливка крупны
 графически
 объектов на фоне Tertiary Container.
* **Tertiary Transparent** — полупрозрачный цвет для выделения прозрачны
 элементов на повер
ности, например, для
...
![Роли Tertiary в светлой и тёмной тема
][image12]
