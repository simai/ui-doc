...
использовать дополнительные цвета (белый и чёрный) для корректного расчёта полупрозрачны
 оттенков:
...
Важно, чтобы цвета для чёрного, белого и прозрачного были объявлены первыми в коде, что обеспечит и
 доступность при
вычислении други
 цветовы
 переменны
