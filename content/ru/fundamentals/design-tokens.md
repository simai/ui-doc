...
с назначением в интерфейсе. И
 можно переопределять на уровне проекта, не
...
полезно связать и
 с ролями, например `--project-layer-modal:
var(--sf-z-index-8)`.

## Тени и фокус

Доступны уровни `--sf-ui-shadow-1` — `--sf-ui-shadow-5`, вер
няя тень
