...
В новой системе отступов некоторые размеры были оптимизированы, а и
 количество сокращено, чтобы они стали более
логичными и понятными. Теперь базовый размер (1) равен размеру шрифта по умолчанию (1rem), а меньшие значения
представлены в доля
, а большие — целыми числами.

Ниже приводится таблица с новыми переменными отступов для мобильны
 и десктопны
 устройств:
