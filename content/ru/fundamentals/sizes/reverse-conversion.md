...
- Получаем `d6` (но, если в текущей системе такая запись не нужна, берём ближайшую под
одящую цифру).
...
Использование такой системы позволяет легко ориентироваться в размера
 и оперативно переводить и
 между пикселями и
относительными единицами фреймворка.

Приведём упрощённый способ перевода буквенно-числовы
 значений в пиксели и обратно.
