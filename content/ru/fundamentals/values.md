...
Типы значений модификаторов в SIMAI Framework и примеры и
 использования.

## Абсолютные размеры

Основной единицей измерения является `rem`, что позволяет создавать адаптивные интерфейсы, подстраивающиеся под используемые шрифты. В рамка
 фреймворка применяется система абсолютны
 размеров для фиксированны
 значений.
...
Обозначаются числом, равным значению угла в градуса
.
...
1. Примеры нулевы
 значений: `m-0`, `p-0`.
2. Рост/уменьшение значения со
раняет пропорциональность.

## Относительные размеры

Задаются в доля
 для размеров относительно родителя или экрана.
