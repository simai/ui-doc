...
сплошные, двойные, скрытые или отсутствующие, а также применять и
 ко всем сторонам сразу или только к определённым
сторонам или осям.
...
- `hidden` — граница скрывается (по
ож на none, но влияет на таблицы с collapse).
