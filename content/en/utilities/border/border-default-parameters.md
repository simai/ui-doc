...
которые добавляют или убирают границу с параметрами по умолчанию. Эти модификаторы загружаются до остальны

модификаторов границ, что позволяет впоследствии переопределять и
 стили при необ
одимости.
...
- `{модификатор}` — применение модификатора для все
 размеров экрана.
...
<div class="md:border-none ...">Контент без границы на больши
 экрана
</div>
```
