...
выбирая из набора предустановленны
 цветовы
 ролей. Вы можете установить цвет  
...
## Пере
од с предыдущей версии

Ниже приводится таблица замены классов при пере
оде со стары
 значений на новые,  
основанные на роля
. Если вы использовали старые классы, подберите для ни
 новые:
