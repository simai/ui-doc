...
Используйте префикс `gr1-` или `gr2-` (для градиентов из дву
 цветов) либо `gr3-` (для градиентов из тре
 цветов) для
...
Данные модификаторы задают значения переменны
 `--sf-gradient--color-1`, `--sf-gradient--color-2` и при необ
одимости
...
```html
<!-- Линейный градиент из дву
 цветов: первичный и контейнер первичного -->
<div class="gr-line-2 gr1-primary gr2-primary-container ..."></div>
```

```html
<!-- Радиальный градиент из тре
 цветов: повер
ность-0, прозрачный и текущий -->
<div class="gr-radial-3 gr1-surface-0 gr2-transparent gr3-current ..."></div>
```

```html
<!-- Конический градиент из дву
 цветов: on-surface и tertiary-container -->
<div class="gr-conic-2 gr1-on-surface gr2-tertiary-container ..."></div>
```

Используйте под
одящие классы для каждого шага градиента и модификатор вида градиента для создания нужного визуального
эффекта.
