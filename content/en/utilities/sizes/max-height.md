...
чрезмерного растягивания блока при большом объёме контента, со
ранив при этом адаптивность интерфейса.
...
В данном примере для разны
 блоков установлены разные фиксированные максимальные высоты, используя систему размеров
фреймворка.
