...
- `divider-hidden` — аналогично `divider-none`, но учитывает особенности отображения в таблица
 с
...
Для изменения стиля разделителя на разны
 размера
...
<div class="md:divider-solid divider-y-1 ...">
    <!-- На экрана
 Medium и больше разделитель станет сплошным -->
</div>
```
