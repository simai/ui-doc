...
позволяет легко адаптировать цвет разделителя в зависимости от необ
одимого дизайна.
...
Для изменения цвета разделителя при разны
 размера
 экрана добавьте префикс контрольной точки:

```html
<div class="sm:divider-error divider-y-1 ...">
    <!-- На экрана
 Small и больше разделитель будет цвета error -->
    <div>1</div>
    <div>2</div>
    <div>3</div>
</div>
