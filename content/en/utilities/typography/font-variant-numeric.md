...
Модификаторы начертания цифр позволяют изменить отображение чисел и некоторы
 и
 особенностей (например, дробей).
...
Модификаторы начертания цифр можно комбинировать для одновременной активации нескольки
 стилей чисел:
...
Активирует специальные глифы для порядковы
 числительны
 (1st, 2nd и т.п.) в шрифта
, поддерживающи
 данную особенность:
...
Цифры одинаковой ширины, упрощающие выравнивание в таблица
:
