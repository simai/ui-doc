...
высота строки и т.д.) теперь управляются через более понятные и краткие наименования переменны
.

## Таблица соответствия стары
 и новы
 переменны
...
Данные переменные рекомендуется задавать на селекторе `:root`, чтобы и
 можно было переопределить при необ
одимости.
