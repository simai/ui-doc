...
Модификаторы цвета обводки определяют цвет линии (штри
а) для SVG-элементов.  
...
- Было: `stroke-info-default`  
  Стало: `stroke-primary` (или другой под
одящий цвет, в зависимости от цели)

Используйте таблицу выше и соответствующие роли для пере
ода со стары
 классов к новым.
