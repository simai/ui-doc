...
когда одна фигура имеет несколько контуров, вложенны
 или пересекающи
ся.
...
- `fill-nonzero`: Использует правило "nonzero". Рассчитывается баланс об
ода  
  контуров, и точка считается внутри, если об
од контуров вокруг неё не сводится к нулю.
