...
на элемента
, имеющи
 привязку прокрутки. Они задают, возможно ли "проскочить" мимо возможны
 позиций привязки или
контейнер будет всегда останавливаться на каждом элементе.

## Краткое описание

С помощью данны
 модификаторов можно указать, будет ли пользователь при прокрутке останавливаться на каждом элементе (
snap-always) или сможет "проскользнуть" мимо определенны
 позиций (snap-normal).
