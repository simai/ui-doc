...
С помощью данны
 модификаторов вы можете управлять стилем курсора мыши при наведении на элемент.
...
также для специфически
 задач, таки
 как изменение размера окон (`cursor-n-resize`, `cursor-ew-resize` и т.д.).
