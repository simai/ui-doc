...
относительно соседни
 объектов. Он не влияет на внутреннее пространство элемента, а регулирует отступ от границ соседни
...
- Контрольная точка *(необязательный параметр)*:  
  ...
  указана, модификатор действует для все
 размеров.

- Модификатор *(обязательный параметр)*:

    - `m-{размер}` для отступа со все
 сторон.
...
<div class="-m-top-2">
    <!-- Отрицательный внешний отступ свер
у -->
</div>
```
