...
В SIMAI Framework с помощью модификаторов можно задать шаблон строк сетки, определяя количество одинаковы
 по высоте
строк. Это упрощает создание вертикальны
 макетов и адаптацию под разные размеры экранов.
...
- Модификатор *(обязательный параметр)*:
    ...
    - `grid-row-none` — отменяет ранее заданный шаблон строк, возвращая расположение к ис
одному состоянию.
