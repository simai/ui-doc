...
- [Насыщенность элемента (filter-saturate)](/en/utilities/filters/filter-saturate/)
- [Сепия элемента (filter-sepia)](/en/utilities/filters/filter-sepia/)

## Связанные категории
- [Фильтры подложки](/en/utilities/backdrop-filter/)
- [Анимация](/en/utilities/animation/)
