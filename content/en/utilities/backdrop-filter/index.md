...
- [Насыщенность подложки (backdrop-saturate)](/en/utilities/backdrop-filter/backdrop-saturate/)
- [Сепия подложки (backdrop-sepia)](/en/utilities/backdrop-filter/backdrop-sepia/)

## Связанные категории
- [Фильтры элемента](/en/utilities/filters/)
- [Фоновое изображение](/en/utilities/background-image/)
- [Градиент](/en/utilities/background-gradient/)
