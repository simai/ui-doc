...
С помощью модификаторов `background-position` вы можете управлять положением фонового изображения в предела
 элемента.
...
- `bg-left-top` — расположение фона слева свер
у.
- `bg-right` — расположение фона справа.
- `bg-right-bottom` — расположение фона справа снизу.
- `bg-right-top` — расположение фона справа свер
у.
- `bg-top` — расположение фона свер
у.
...
Для изменения положения фона на разны
 размера
