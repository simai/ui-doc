...
- `outline-offset-{1...4}` — устанавливают отступ в соответствии со шкалой адаптивны
 величин фреймворка.
...
Для изменения отступа внешней границы на разны
 размера
 экрана используйте префикс контрольной точки:

```html
<!-- На экрана
 от Medium и больше отступ внешней границы будет 2 -->
