...
- Модификатор (обязательный параметр):
    ...
    - `isolation-auto` — автоматически создаёт новый контекст наложения, если это необ
одимо. Если ни одно из свойств не
...
### `isolation-auto`  
С помощью модификатора `isolation-auto` новый контекст наложения создаётся по необ
одимости:
