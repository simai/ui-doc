...
The spacing scale was streamlined to stay more logical and readable. The base size (1) equals the default font size
(1rem); smaller values are fractional, larger values are whole numbers.

New spacing variables for mobile and desktop:
