...
* **Body text:**  
  Line height ≈ 1.5 × font size. If not a 0.25rem multiple, round down to the nearest step.
* **Headings:**  
  Line height ≈ 1.2 × font size with a minimum of 1. Round down to the nearest 0.25rem.
