...
> Для новых интерфейсов с автоскрытием, расширением области захвата,
> перетаскиванием и готовыми режимами используйте компонент
> [sf-scrollbar](scrollbar-presets.md). `.scroll-hover` сохраняется как
> совместимая низкоуровневая утилита для нативной полосы браузера.
