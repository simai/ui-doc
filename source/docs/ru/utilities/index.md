...
## Направление (LTR/RTL)
- Фреймворк сохраняет явно заданный `dir` на `<html>` и добавляет вычисленное направление, только если атрибут отсутствует.
...
- Подробнее: [поддержка LTR и RTL](../fundamentals/directions/).
