...
- [Инвертирование цвета фона элемента (backdrop-invert)](backdrop-invert.md)
- [Прозрачность фона элемента (backdrop-opacity)](backdrop-opacity.md)
- [Насыщенность подложки (backdrop-saturate)](backdrop-saturate.md)
- [Сепия подложки (backdrop-sepia)](backdrop-sepia.md)
