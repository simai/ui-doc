...
```html
<span
  class="box-slice bg-clip-text color-transparent gr-line-2 gr-to-top gr1-tertiary gr2-error">
  Hello<br />
  World
</span>
```
...
```html
<span
  class="box-clone bg-clip-text color-transparent gr-line-2 gr-to-top gr1-tertiary gr2-error">
  Hello<br />
  World
</span>
```
